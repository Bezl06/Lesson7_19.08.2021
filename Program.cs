...
namespace Lesson7
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            book2.content.Show();
            Console.ResetColor();
            //Услования была слегка непонятны поэтому сделал две реализации задачи
            //реализация №1 реализована возможность добавления инф-ы через конструктор
            //реализация №2 реализована возможность добавления инф-ы через метод
        }
    }
    class Rectangle
    {
